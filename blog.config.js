...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://midi-touch-f8d.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'Plog', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YogaTree', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '瑜伽树（中国）', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yogatree.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yoga,blog', // 网站关键词 英文逗号隔开
